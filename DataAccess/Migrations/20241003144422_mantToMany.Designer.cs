...
namespace EF_DataAccess.Migrations
{
    ...
    [Migration("20241003144422_mantToMany")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fluent_AuthorFluent_Book", b =>
                {
                    ...
                    b.Property<int>("Fluent_BooksBookID")
                        .HasColumnType("int");

                    b.HasKey("Fluent_AuthorsAuthor_Id", "Fluent_BooksBookID");

                    b.HasIndex("Fluent_BooksBookID");
            ...
            modelBuilder.Entity("Fluent_AuthorFluent_Book", b =>
                {
                    b.HasOne("EF_Models.Models.Fluent_Author", null)
                        .WithMany()
                        .HasForeignKey("Fluent_AuthorsAuthor_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EF_Models.Models.Fluent_Book", null)
                        .WithMany()
                        .HasForeignKey("Fluent_BooksBookID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
